(function () {
  ...
  class MapComposition extends Svg {
    ...
    constructor(id, size = {}, options = {}) {
      ...
      this._zoom = d3$6.zoom().scaleExtent([1, 15]).translateExtent([[0, 0], [this.size.width, this.size.height]]).on('zoom', e => this._handleZoom.call(this, e)); // this.outerContainer.call(this._zoom);
    ...
    _handleZoom(e) {
      ...
      if (e.sourceEvent && !this._zoomEvent.source || !e.sourceEvent && this._zoomEvent.source) {
        ...
        console.warn('change!!!'); //  console.log(this.state.animationPending);
      } //Zoom programmatique
      ...
      if (e.sourceEvent === null) {
        ...
        labels.style('font-size', `${24 / e.transform.k}px`); //Dispatch

        this.dispatch.call('zoom', this, {
          level: e.transform.k,
    ...
    zoomTo(selection, zoomMargin = 1) {
      this._animationPending = new Promise((resolve, reject) => {
        ...
        this.freezoom(false); //Calcul du zoom
        ...
        this.outerContainer.transition().delay(this._options.delay).duration(this._options.duration).call(this._zoom.transform, finalTransform).on('start', () => {
  ...
  class DropdownList {
    ...
    update(data = null, structure = null) {
      ...
      if (data !== null) {
        ...
        if (this._structure.placeholder) {
          this._innerContainer.append('option').property('disabled', true).property('selected', true).property('hidden', true).text(this._structure.placeholder);
        }
    ...
    select(value) {
      ...
      this._innerContainer.selectAll('option').property('selected', d => console.log(d));
  ...
  class NestedSelection extends Component {
    ...
    data(data, structure) {
      ...
      for (let i = 0; i <= this.size - 1; i++) {
        ...
        this._sections[i] = new DropdownList(i).appendTo(this).update(i === this.size - 1 ? this._data : null, this._structure[i]).on('change', msg => {
